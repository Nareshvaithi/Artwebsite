...
const Hero = () => {
    ...
    return (
        <div className="relative w-full h-auto pt-36 px-3 lg:px-10">
            {/* Background Overlay */}
            <div className="absolute inset-0 bg-no-repeat bg-cover bg-center opacity-70 herobanner"></div>
            ...
            <div className="relative bg-transparent">
                <div className="text-center flex justify-center bg-transparent">
                    <h1
                        ...
                        className="font-Aboreto w-fit text-[40px] select-none capitalize bg-transparent"
                ...
                <div className="bg-transparent">
                    <div className="pl-20 pt-36">
                        <div onClick={()=>navigate('/')} data-rellax-mobile-speed="0.5" data-rellax-speed="1" className="rellax group bg-transparent border border-gray-400 hover:border-red-400 rounded-full px-1 py-16 w-fit h-fit">
                            <NavLink onClick={()=>navigate('/')} onMouseEnter={cursorEnter} onMouseLeave={cursorLeave} className={"bg-gray-100 group-hover:text-red-400 px-8 py-16 text-3xl rounded-full font-Aboreto"}>Home</NavLink>
                        </div>
                    </div>
                    <div className="pr-40 -mt-72">
                        <div onClick={()=>navigate('/artist')} data-rellax-mobile-speed="0.5" data-rellax-speed="1" className="rellax group bg-transparent border border-gray-400 hover:border-orange-400 rounded-full px-1 py-16 w-fit h-fit ml-auto">
                            <NavLink onClick={()=>navigate('/')} onMouseEnter={cursorEnter} onMouseLeave={cursorLeave} className={"bg-gray-100 group-hover:text-orange-400 px-8 py-16 text-3xl rounded-full font-Aboreto"}>Artist</NavLink>
                        </div>
                    </div>
                    <div className="mt-60">
                        <div onClick={()=>navigate('/artist')} data-rellax-mobile-speed="0.5" data-rellax-speed="1" className="rellax group bg-transparent border border-gray-400 hover:border-blue-400 rounded-full px-1 py-24 w-fit h-fit mx-auto">
                            <NavLink onClick={()=>navigate('/')} onMouseEnter={cursorEnter} onMouseLeave={cursorLeave} className={"bg-gray-100 group-hover:text-blue-400 px-10 py-24 text-3xl rounded-full font-Aboreto"}>Artwork</NavLink>
                        </div>
                    </div>
                    <div className="pl-40 mt-20">
                        <div onClick={()=>navigate('/artist')} data-rellax-mobile-speed="0.5" data-rellax-speed="1" className="rellax group bg-transparent border border-gray-400 hover:border-green-400 rounded-full px-1 py-16 w-fit h-fit mr-auto">
                            <NavLink onClick={()=>navigate('/')} onMouseEnter={cursorEnter} onMouseLeave={cursorLeave} className={"bg-gray-100 group-hover:text-green-400 px-6 py-16 text-3xl rounded-full font-Aboreto"}>Shorts</NavLink>
                        </div>
                    </div>
                    <div className="pr-40 -mt-36">
                        <div onClick={()=>navigate('/artist')} data-rellax-mobile-speed="0.5" data-rellax-speed="1" className="rellax group bg-transparent border border-gray-400 hover:border-yellow-400 rounded-full px-1 py-20 w-fit h-fit ml-auto">
                            <NavLink onClick={()=>navigate('/')} onMouseEnter={cursorEnter} onMouseLeave={cursorLeave} className={"bg-gray-100 group-hover:text-yellow-400 px-6 py-20 text-3xl rounded-full font-Aboreto"}>contact</NavLink>
                        </div>
                    </div>
                </div>
            </div>
