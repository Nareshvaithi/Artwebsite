...
const Hero = () => {
    ...
    return (
        <div className="relative w-full h-auto pt-36 px-3 lg:px-10">
            {/* Background Overlay */}
            <div className="absolute inset-0 bg-no-repeat bg-cover bg-top opacity-70 herobanner"></div>
            ...
            <div className="relative bg-transparent">
                <div className="text-center flex justify-center bg-transparent">
                    <h1
                        ...
                        className="font-Aboreto text-white leading-normal w-fit text-4xl capitalize bg-transparent"
